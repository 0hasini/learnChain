...
export const DashboardComponent = () => {
  ...
  const cardBase =
    "flex items-center justify-center text-center font-bold text-gray-800 bg-gradient-to-br from-blue-100 to-white rounded-2xl shadow-lg cursor-pointer transition-transform duration-200 hover:scale-105 select-none text-xl min-h-[185px] p-6";
  ...
  return (
    <div className="grid grid-cols-3 grid-rows-2 gap-8 w-full max-w-[800px] mx-auto">
      ...
      <div className={`${cardBase} row-start-1 row-span-2 col-start-3 flex flex-col justify-center items-center text-3xl font-extrabold min-h-[200px]`} onClick={() => handleNav("question")}>Post/Answer a question</div>
    </div>
  );
}
